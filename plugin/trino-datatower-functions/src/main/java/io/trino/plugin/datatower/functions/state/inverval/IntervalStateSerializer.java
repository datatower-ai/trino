 ...
 * @author liulin
 */
public class IntervalStateSerializer
        implements AccumulatorStateSerializer<IntervalState>
{
    ...
    public void serialize(IntervalState state, BlockBuilder out)
    {
    ...
    public void deserialize(Block block, int index, IntervalState state)
    {
