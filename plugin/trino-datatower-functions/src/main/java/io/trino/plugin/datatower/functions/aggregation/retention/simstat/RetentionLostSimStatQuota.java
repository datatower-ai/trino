 ...
 * @author liulin
 */
public class RetentionLostSimStatQuota
{
    private static final long INSTANCE_SIZE = instanceSize(RetentionLostSimStatQuota.class);
    ...
    RetentionLostSimStatQuota(RetentionLostSimStatItem[] table, int rowCount, long statType, long[] quotaType, long[] quotaIndex)
    {
        this.table = table;
    ...
    static RetentionLostSimStatQuota merge(RetentionLostSimStatQuota left, RetentionLostSimStatQuota right)
    {
        ...
        if (rightRowCount == 0) {
            ...
            return new RetentionLostSimStatQuota(table, i, left.getStatType(), left.quotaType, left.quotaIndex);
        }
    }
    ...
    int estimateMemorySize()
    {
        ...
        return (int) ((long) INSTANCE_SIZE + SizeOf.sizeOf(this.quotaIndex) + SizeOf.sizeOf(this.quotaType) + SizeOf.sizeOf(this.table) + rowSize * (long) this.rowCount);
    }
