 ...
 * @author liulin
 */
@AggregationFunction("retention_lost_date_sim_stat_quota_array_agg")
public final class RetentionLostDateSimStatQuotaCollectAggFunction
{
    private RetentionLostDateSimStatQuotaCollectAggFunction()
    {
    }
