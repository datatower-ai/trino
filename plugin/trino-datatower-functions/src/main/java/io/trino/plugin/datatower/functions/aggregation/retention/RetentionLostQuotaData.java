...
class RetentionLostQuotaData
{
    private static final long INSTANCE_SIZE = instanceSize(RetentionLostQuotaData.class);
    private final long[][] table;
    private final int rowCount;
    private final long[] quotaType;
    private final long[] quotaIndex;

    public RetentionLostQuotaData(long[][] table, int rowCount, long[] quotaType, long[] quotaIndex)
    {
        this.table = table;
    ...
    static RetentionLostQuotaData merge(RetentionLostQuotaData left, RetentionLostQuotaData right)
    {
        ...
        if (rightRowCount == 0) {
            ...
            while (true) {
                ...
                return new RetentionLostQuotaData(table, i, left.getQuotaType(), left.getQuotaIndex());
            }
        }
    }
