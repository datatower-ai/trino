 ...
 * @author liulin
 */
@AggregationFunction("build_user_interval_agg_grouped")
@Description("returns  event_time,interval,groups row")
public class IntervalAggFunctionGrouped
{
    ...
    private IntervalAggFunctionGrouped()
    {
    }
    ...
    public static void input(@AggregationState IntervalState state,
            ...
            @SqlType("bigint") long numOfGroups,
    ...
    {
        if (sessionEntity.getIntervalUnit() == 0) {
