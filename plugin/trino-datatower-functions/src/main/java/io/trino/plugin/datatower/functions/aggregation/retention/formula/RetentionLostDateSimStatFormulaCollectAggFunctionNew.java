...
@AggregationFunction("retention_lost_date_sim_stat_formula_collect_agg_new")
public final class RetentionLostDateSimStatFormulaCollectAggFunctionNew
{
    private RetentionLostDateSimStatFormulaCollectAggFunctionNew()
    {
    }
            ...
            @SqlType("array(varchar)") Block paramBlock)
    {
        ...
        Slice unit = VarcharType.VARCHAR.getSlice(paramBlock, 1);
        Slice formula = VarcharType.VARCHAR.getSlice(paramBlock, 2);
