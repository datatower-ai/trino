...
{
    protected static final Duration DEFAULT_OPERATION_TIMEOUT = new Duration(30, TimeUnit.SECONDS);
    ...
    private KuduScannerConfig scannerConfig = new KuduScannerConfig();
